...
import com.example.EXAMEN.LP2.RESURECCION.controller.respuestas.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({BussinessException.class, ServiceException.class, ResourceValidationException.class})
